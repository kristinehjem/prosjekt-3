...
export default function MovieModal() {
  ...
  function closeModal() {
    dispatch(updateModalInfo({ showing: false }));
  }

  return (
    <Modal open={modalInfo.showing} onClose={closeModal}>
      <Box id="modalBox">
        ...
        <Typography component="legend" id="userRating">
          Add your rating
        </Typography>
        <Rating
          id="rating-selector"
